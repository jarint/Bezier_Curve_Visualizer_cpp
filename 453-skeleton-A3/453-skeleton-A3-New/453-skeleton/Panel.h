...
// class Panel {
// public:
//   // multi_view_port_enabled allows the panel to be moved out of the window,
//   // though it seems to be a bit buggy on some machines
...
// private:
//   std::unique_ptr<ImGuiContext, PanelDeleter>
//       imguiContext; // Manage ImGui context
//   std::shared_ptr<PanelRendererInterface>
//       panelRenderer; // optional shared owning ptr (user provided)
// };
